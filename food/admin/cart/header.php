...
<nav class="navbar navbar-expand-lg navbar-custom px-3" style="background:rgba(102, 21, 21, 1);">
    ...
    <div class="collapse navbar-collapse" id="navbarContent">
      <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-item" style="padding-right:10px;">
          <a style="color:white;" class="nav-link" href="../profile"><i class="fas fa-user me-2"></i>Profile</a>
        </li>
        <li class="nav-item" style="padding-right:10px;">
        ...
        <li class="nav-item" style="padding-right:10px;">
          <a style="color:white;" class="nav-link" href="#"><i class="fas fa-sign-out-alt me-2"></i>Logout</a>
        </li>
      </ul>
    </div>
  </nav>
